package com.webapp.manager.views.доступныезадачи;
...
@PageTitle("Доступные Задачи")
@Route(value = "data-grid", layout = MainLayout.class)
@PermitAll
public class ДоступныеЗадачиView extends Div {
    ...
    public ДоступныеЗадачиView() {
        addClassName("доступные-задачи-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
