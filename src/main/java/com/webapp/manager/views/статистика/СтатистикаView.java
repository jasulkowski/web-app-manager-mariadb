package com.webapp.manager.views.статистика;
...
import com.webapp.manager.views.статистика.ServiceHealth.Status;
import jakarta.annotation.security.PermitAll;

@PageTitle("Статистика")
@Route(value = "dashboard", layout = MainLayout.class)
@PermitAll
public class СтатистикаView extends Main {

    public СтатистикаView() {
        addClassName("статистика-view");
