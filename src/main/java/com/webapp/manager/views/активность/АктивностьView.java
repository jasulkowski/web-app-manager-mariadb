package com.webapp.manager.views.активность;
...
@PermitAll
public class АктивностьView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public АктивностьView() {
        addClassName("активность-view");
        setSizeFull();
        grid.setHeight("100%");
